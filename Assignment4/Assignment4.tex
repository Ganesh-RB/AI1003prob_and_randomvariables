...
\begin{align}
    M_{X}\brak{t} \equiv E\brak{e^{t X}} = \sum_{k=-\infty}^{\infty} e^{t k}\times {\text{Pr}}_X\brak{k}
\end{align}
$n^{\text{th}}$ Moment of $X$
\begin{align}
    {\sbrak{\frac{d^n}{d t^n}Y\brak{t}}}_{t=0}=&{\sbrak{\sum_{k=-\infty}^{\infty} k^n \times e^{t k} \times {\text{Pr}}_X\brak{k}}}_{t=0}
    \\=&\sum_{k=-\infty}^{\infty} k^n \times {\text{Pr}}_X\brak{k}
    \\=&E\brak{X^n}
\end{align}

By defining Moment generating function of $X_i$ for $i \in \cbrak{1,2,3,4} $
\begin{align}
...
\begin{align}
    E\brak{Y^4}=&{\sbrak{\frac{d^4}{d t^4}Y\brak{t}}}_{t=0}
