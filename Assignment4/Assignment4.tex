...
\begin{align}
    E\brak{X}=& n p 
    \\E\brak{X^2}=& p^2n(n-1)+ p n
    \\E\brak{X^3}=& p^3n(n-1)(n-2)+3p^2n(n-1)+ p n
    \\
    \begin{split}
         E\brak{X^4}=& p^4n(n-1)(n-2)(n-3)
    \\&+6p^3n(n-1)(n-2)\\&\qquad+7p^2 n(n-1) +n p
    \end{split}
\end{align}
...
Here $Z$ will be  binomial random variable with parameter $n=4$ and $p=0.5$ 
