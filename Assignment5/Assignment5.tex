...
{
\small
1) $\lim \limits_{n \to \infty} $ \pr{X_n > (n+1)^2}
\begin{align}
...
\\[8ex]
2) $\lim \limits_{n \to \infty} $ \pr{X_n \leqslant (n+1)^2}
\begin{align}
...
\\[4ex]3) $\lim \limits_{n \to \infty} $ \pr{X_n < (n-1)^2}
\begin{align}
...
\\[4ex]
4) $\lim \limits_{n \to \infty} $ \pr{X_n < (n-2)^2}
\begin{align}
