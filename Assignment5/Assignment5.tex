...
\begin{enumerate}
    \item $\lim \limits_{n \to \infty} $ Pr\,\brak{X_n > (n+1)^2}
    \item $\lim \limits_{n \to \infty} $ Pr\,\brak{X_n \leqslant (n+1)^2}
    \item $\lim \limits_{n \to \infty} $ Pr\,\brak{X_n<(n-1)^2}
    \item $\lim \limits_{n \to \infty} $ Pr\,\brak{X_n<(n-2)^2}
\end{enumerate}
...
{
\small
1) $\lim \limits_{n \to \infty} $ Pr\,\brak{X_n > (n+1)^2}
\begin{align}
...
\\[4ex]2) $\lim \limits_{n \to \infty} $ Pr\,\brak{X_n \leqslant (n+1)^2}
\begin{align}
...
\\[4ex]2) $\lim \limits_{n \to \infty} $ Pr\,\brak{X_n < (n-1)^2}
\begin{align}
...
\\[4ex]2) $\lim \limits_{n \to \infty} $ Pr\,\brak{X_n < (n-2)^2}
\begin{align}
